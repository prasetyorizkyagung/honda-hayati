      ...
      <div class="col-md-12">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="varchar">Nama Dealer <?php echo form_error('nama_dealer') ?></label>
                <input type="text" class="form-control" name="nama_dealer" id="nama_ahass" placeholder="Nama Dealer" value="<?php echo $nama_dealer; ?>" />
            </div>
            <div class="form-group">
            ...
            <a href="<?php echo site_url('dealer') ?>" class="btn btn-default">Cancel</a>
        </form>
      </div>
      <!-- /.col -->
    </div>
