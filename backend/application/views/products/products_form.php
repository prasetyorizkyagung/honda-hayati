...
<div class="box box-danger">
  ...
  <div class="box-body">
    <div class="row">
      ...
      <div class="form-group">
            <label for="ket_products">Ket Products <?php echo form_error('ket_products') ?></label>
            <textarea class="form-control" placeholder="Place some text here" name="ket_products" id="ket_products"
                          style="width: 100%; height: 200px; resize: none"><?php echo $ket_products; ?></textarea>
        </div>
