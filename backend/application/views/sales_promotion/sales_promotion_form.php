...
<div class="box box-danger">
  ...
  <div class="box-body">
    <div class="row">
      ...
      <div class="form-group">
            <label for="ket_sales_promotion">Ket Sales Promotion <?php echo form_error('ket_sales_promotion') ?></label>
            <textarea class="form-control" placeholder="Place some text here" name="ket_sales_promotion" id="ket_sales_promotion"
                          style="width: 100%; height: 200px; resize: none"><?php echo $ket_sales_promotion; ?></textarea>
        </div>
